	...
	SecurityFilterChain securityFilterChain(
		...
		return http
				...
				.authorizeHttpRequests(authorize -> authorize
						...
						.hasAnyRole("MANAGER", "ADMIN")
						.requestMatchers(HttpMethod.POST, "/api/master/file-name-formats",
								"/api/master/file-name-formats/**").hasAnyRole("MANAGER", "ADMIN")
						.requestMatchers(HttpMethod.PUT, "/api/master/file-name-formats/**")
							.hasAnyRole("MANAGER", "ADMIN")
						...
						.requestMatchers(HttpMethod.GET, "/api/members/search-by-skill")
							.hasAnyRole("MANAGER", "ADMIN")
						.requestMatchers(HttpMethod.GET, "/api/members/search-by-language")
							.hasAnyRole("MANAGER", "ADMIN")
						.requestMatchers(HttpMethod.POST, "/api/members/search")
							.hasAnyRole("MANAGER", "ADMIN")
						.requestMatchers(HttpMethod.GET, "/api/members")
							.hasAnyRole("MANAGER", "ADMIN")
						.requestMatchers(HttpMethod.GET, "/api/users")
							.hasAnyRole("MANAGER", "ADMIN")
						.requestMatchers(HttpMethod.GET, "/api/dashboard/manager-stats")
							.hasAnyRole("MANAGER", "ADMIN")
